...
const testimonials = [
  {
    ...
    avatar: "SM",
    rating: 5,
    text: "MindSukoon helped me through exam stress like nothing else. The AI chat was there at 3 AM when I needed it most.",
  },
  {
    name: "Alex K.",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16 space-y-4 animate-fade-in-up">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Real experiences from students who found strength, balance, and support through MindSukoon Campus.
          </p>
        </div>
